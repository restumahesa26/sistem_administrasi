                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('seminar-hasil.edit', $item->id) }}" class="btn btn-sm btn-primary">Ubah</a>
                                    <form action="{{ route('seminar-hasil.destroy', $item->id) }}" method="POST" class="d-inline btn-hapus">
                                        @csrf
                                        @method('DELETE')

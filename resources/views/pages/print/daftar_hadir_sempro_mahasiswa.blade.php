...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Cetak Daftar Hadir Seminar Proposal Mahasiswa</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Cetak Daftar Hadir Seminar Proposal Mahasiswa</li>
    </ol>
</div>
...
<div class="row mb-3">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('daftar-hadir-seminar-proposal-mahasiswa.print') }}" method="GET" target="_blank">

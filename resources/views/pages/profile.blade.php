...
<form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $item->nama) }}" placeholder="Masukkan Nama">
                        @error('nama')
        ...
        <div class="col-lg-6">
            ...
            <button type="submit" class="btn btn-primary btn-block mt-3">Simpan Profile</button>
        </div>
    </div>
</form>
@endsection

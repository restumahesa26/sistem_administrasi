...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Sidang Skripsi</li>
    </ol>
</div>

<form action="{{ route('sidang-skripsi.store') }}" method="POST">
    @csrf
    @if($errors->any())
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tanggal_sidang" id="tanggal_sidang" class="form-control @error('tanggal_sidang') is-invalid @enderror" value="{{ old('tanggal_sidang') }}" placeholder="Masukkan Tanggal Sidang Skripsi" readonly>

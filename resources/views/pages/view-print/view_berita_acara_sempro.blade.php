...
<body>
    <div class="container" style="padding-left: 50px; padding-right: 50px;">
        ...
        <p class="mt-4 text-justify">Pada hari ini {{ \Carbon\Carbon::parse($data_sempro->tanggal)->translatedFormat('l') }} tanggal {{ \Carbon\Carbon::parse($data_sempro->tanggal)->translatedFormat('d') }} bulan {{ \Carbon\Carbon::parse($data_sempro->tanggal)->translatedFormat('F') }} tahun {{ \Carbon\Carbon::parse($data_sempro->tanggal)->translatedFormat('Y') }}, telah dilaksanakan Seminar Proposal Skripsi mahasiswa :</p>
